...
.form-control:focus {
  ...
  border-color: #1787db;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(11, 64, 104, 0.25);
}
...
.btn-primary:focus, .btn-primary.focus {
  ...
  background-color: #ab8f3b;
  border-color: #ab8f3b;
  box-shadow: 0 0 0 0.2rem rgba(48, 93, 127, 0.5);
}
...
.btn-outline-primary:focus, .btn-outline-primary.focus {
  box-shadow: 0 0 0 0.2rem rgba(11, 64, 104, 0.5);
}
...
.custom-range:focus::-webkit-slider-thumb {
  box-shadow: 0 0 0 1px #fff, 0 0 0 0.2rem rgba(11, 64, 104, 0.25);
}
...
.bg-primary {
  background-color: #d9b336 !important;
}
